...
class S2SConfig(BaseModel):
    enabled: bool = True
    listen_host: str = "0.0.0.0"
    listen_port: int = 54110
    shared_secret: str = Field(default="change-me", min_length=4)
    version: int = 1


class DatabaseConfig(BaseModel):
    dsn: str = "postgresql://postgres:postgres@127.0.0.1:5432/bouteagle"
    min_size: int = 2
    max_size: int = 20
